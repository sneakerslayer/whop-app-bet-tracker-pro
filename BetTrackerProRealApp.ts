        ...
        <Card className="mt-8 bg-blue-500/10 border-blue-500/20">
          <CardContent className="p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="font-medium text-blue-400 mb-1">BetTracker Pro - Development Version</h4>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-xs">
                  ...
                  <div>
                    ...
                    <p className="text-yellow-400">◐ Whop SDK</p>
                  </div>
                  <div>
                    <span className="text-blue-200">Payments:</span>
                    <p className="text-yellow-400">◐ Ready</p>
                  </div>
                </div>
              </div>
            </div>
